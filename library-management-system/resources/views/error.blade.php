        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <div class="text-center">
                    <div class="mb-3">
                        <!-- img -->
                        <img src="{{ asset('design') }}/assets/images/error/404-error-img.png" alt=""
                            class="img-fluid">
                    </div>
                    <!-- text -->
                    <h1 class="display-4 fw-bold">Oops! The page not found <br>Or You are not eligible to access this
                        page.</h1>
