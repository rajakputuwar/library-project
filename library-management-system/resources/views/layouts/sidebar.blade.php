<nav class="navbar-vertical navbar">
    <div class="nav-scroller">
        ...
        <ul class="navbar-nav flex-column" id="sideNavbar">
            ...
            <li class="nav-item">
                <a class="nav-link @if(Route::is('categories.*')) active @endif" href="{{ route('categories.index') }}">
            ...
            <li class="nav-item">
                <a class="nav-link has-arrow @if(Route::is('books.*')) active @endif " href="{{ route('books.index') }}">
                    <i data-feather="sidebar" class="nav-icon icon-xs me-2">
                    </i>
                    Books
                </a>
