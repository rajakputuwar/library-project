        ...
        <div class="card-body">
            ...
            <form class="" action="{{ route('users.update', $user->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="text" class="form-control" value="{{ old($user->name) ?? $user->name }}" name="name"
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="number" class="form-control" value="{{ old($user->college_id) ?? $user->college_id }}"
                        name="college_id" id="exampleInputEmail2">
                    @error('college_id')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group mb-2">
                    ...
                    <input type="text" class="form-control" value="{{ old($user->phone) ?? $user->phone }}" name="phone"
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="text" class="form-control" value="{{ old($user->address) ?? $user->address }}"
                        name="address" id="exampleInputEmail2">
                    @error('address')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group mb-2">
                    ...
                    <input type="email" class="form-control" value="{{ old($user->email) ?? $user->email }}" name="email"
                        id="exampleInputEmail2">
                    @error('email')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="form-group mb-2">
                    <img src="{{ asset('uploads/users') . '/' . $user->image }}" class="rounded-circle" height="100px"
                        width="100px">
